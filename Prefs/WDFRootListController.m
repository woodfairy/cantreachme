...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.titleLabel.text = @"CantReachMe";
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/Prefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/Prefs.bundle/Banner.jpg"];
...
-(void)respring {
	UIAlertController *respring = [UIAlertController alertControllerWithTitle:@"CantReachMe"
